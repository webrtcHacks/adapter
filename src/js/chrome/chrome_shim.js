...
module.exports = function(dependencies) {
  ...
  var webkitRTCPeerConnection = window && window.webkitRTCPeerConnection;
  ...
  var chromeShim = {
          ...
          Object.defineProperty(window.HTMLMediaElement.prototype,
            'srcObject',
            {
              ...
              set: function(stream) {
                ...
                // removed. Doing it manually to avoid a recursion.
    ...
    shimPeerConnection: function() {
      ...
      if (!window.RTCPeerConnection) {
        ...
        RTCPeerConnection.prototype = webkitRTCPeerConnection.prototype;
